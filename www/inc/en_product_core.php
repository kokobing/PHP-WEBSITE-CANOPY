...
$strSQL = "select a.*,b.fatherid from productinfo as a left join productdir as b on a.id_proddir=b.id_proddir  where a.id_proddir='$_GET[id2]' and a.dele=1 order by a.ordernum desc" ;
