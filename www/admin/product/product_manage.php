            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="5" cellpadding="3">
                  ...
                  <tr>
                    ...
                    <td width="72%" align="left"><a href="product_manage.php?03<?php echo $arrproductinfos[$i][id_prodinfo]?>&searchselect=<?php echo $searchselect;?>&keywords=<?php echo $keywords;?>"  class="txt_leftmenu"><?php echo cutstr($arrproductinfos[$i][title],60,1);?></a></td>
