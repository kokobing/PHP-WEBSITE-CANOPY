		   ...
		   <?php for($i=0;$i<$intNews;$i++) {?>
            <tr>
              ...
              <table width="100%" border="0" cellspacing="5" cellpadding="3">
                  <tr>
                    <td align="left" width="12%" class="txt_leftmenu">[ <?php echo $arrnewsinfos[$i][name]?> ]</td>
                    <td width="14%" align="left" class="txt_leftmenu">[ <?php echo $arrnewsinfos[$i][newsdate]?> ]</td>
