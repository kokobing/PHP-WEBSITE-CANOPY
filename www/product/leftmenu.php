...
&nbsp;<IMG height=20 src="/../inc/pics/img/class3.gif" width=26 align=absMiddle border=0>&nbsp;<a href="/product/product.php?id2=<?=$getproductdir2[$j][id_proddir];?>&id1=<?=$pdir1[$i][id_proddir];?>"><?=$getproductdir2[$j][name]?></a><BR>
		<? }?>
        </TD>
	</TR>
<? }?>    
