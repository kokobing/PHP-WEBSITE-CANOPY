<table cellspacing="0" cellpadding="0" width="990" align="center" bgcolor="#ffffff" border="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="286" rowspan="2"><a href="/"><img src="/upload/layout/<?=$logo[opicname];?>" width="459" height="87" border="0" /></a></td>
      ...
      <td align="middle" height="53"><table cellspacing="0" cellpadding="0" width="230" align="right" border="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="middle" height="24"><A onclick="var strHref=window.location.href;this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.ty-sh.com');" href="#">设为首页</A> | <A href="javascript:window.external.addFavorite(window.location.href,'上海步瑞起网络科技有限公司')">加入收藏</A>  | 
...
<a href="/en/" id="based" style="cursor:pointer"><font color="#FF3300">English</font></a></td>
  ...
  height="34"><marquee scrollamount=1 scrolldelay=4 width=420
            ...
            align="left" onMouseOver="this.stop()" onMouseOut="this.start()">
                                    ...
                                    <font color='#FFffff'><b>本站公告：</b></font>&nbsp;<a href='#' onclick="javascript:window.open('/announcement.php', 'newwindow', 'height=450, width=400, toolbar=no, menubar=no, scrollbars=auto, resizable=no, location=no, status=no')" title=''><font color='#FFffff'><?=$benzhangg[intro];?>　</font></a></marquee></td>
...
<table cellspacing="0" cellpadding="0" width="990" align="center" border="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      src="/inc/pics/imgbeq/index_04.jpg" width="979" usemap="#MapMap" 
...
<map name="MapMap" id="MapMap">
  ...
  coords="91,4,176,51" href="/" />

  <area shape="rect" 

  coords="798,2,887,47" href="/about/feedback.php" />

  <area shape="rect" 

  coords="210,3,286,43" href="/about/about.php?pageid=1" />

  <area shape="rect" 

  coords="323,3,422,47" href="/news/news.php" />

  <area shape="rect" 

  coords="678,3,759,48" href="/hr/hr.php" />

  <area shape="rect" 

  coords="565,0,643,45" href="/case/case.php" />

  <area shape="rect" 

  coords="437,1,532,47" href="/product/product.php" />
