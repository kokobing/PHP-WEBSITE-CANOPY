...
bgcolor="#ffffff" border="0">
                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>Case</strong></span></td>
  ...
  <tr>
    <td align="left" ><table width="100%" border="0">
        <tr>
          <td width="226"  height="30">&nbsp;<a href='#'>Case</a>&nbsp;&gt;&gt;&nbsp;All success stories </td>
          <td width="227">&nbsp;</td>
          <td width="102"><?=sizeof($arrnews);?> Cases</td>
        </tr>
    </table></td>
  </tr>
  <tr>
                  ...
                  border="0">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="/en/case/su_casepage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>"><img src="/upload/news/<?=getnewspic($arrnews[$i][id_newsinfo]);?>" width="150" height="100" border=0 /></a></td>
                      ...
                      background="/inc/pics/imgbeq/caseBottom02.gif" 
                        ...
                        height="22"><a href="/en/case/su_casepage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>"><font color="#ffffff"><?=$arrnews[$i][title];?></font></a></td>
