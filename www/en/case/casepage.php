<?php
require "../../inc/en_casepage_core.php";
?>
...
bgcolor="#ffffff" border="0">
                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>Applications</strong></span></td>
  ...
  <tr>
              ...
              <td height="35" align="center" class="txt_title" style="BORDER-bottom: #E7E7E7 1px dashed"><?=$onenews[title];?></td>
            ...
            <tr valign="bottom">
              ...
              <td height="30" align="left" valign="middle" class="txt" ><?=$onenews[content];?></td>
