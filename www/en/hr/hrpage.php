<?php
require "../inc/cn_newspage_core.php";
?>
...
bgcolor="#ffffff" border="0">
                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>人才招聘</strong></span></td>
  ...
  <tr>
            ...
            <td width="83%" height="24" align="left" class="txt_title" style="BORDER-bottom: #E7E7E7 1px dashed"><?=$onenews[title];?></td>

            <td width="11%" align="center" style="BORDER-bottom: #E7E7E7 1px dashed"><font color="#999999">[<?=$onenews[newsdate];?>]</font></td>
            ...
            <tr valign="bottom">
              ...
              <td height="30" colspan="3" align="left" valign="middle" class="txt" ><?=$onenews[content];?></td>
