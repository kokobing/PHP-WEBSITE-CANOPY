    ...
    <tr>
                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>Recruitment</strong></span></td>
      ...
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:10px; margin-top:10px;">
            ...
            <tr>
              ...
              <td width="83%" height="35" align="left" style="BORDER-bottom: #E7E7E7 1px dashed"><a href="/en/hr/hrpage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>&ndir=<?=$arrnews[$i][id_newsdir];?>"><?=$arrnews[$i][content];?></a>　</td>
