                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>Message</strong></span></td>
...
border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#E3E3E3">
              ...
              <tr>
                <td height="25" align="right" bgcolor="#FFFFFF">Tel：</td>
              ...
              <tr>
                <td height="25" align="right" bgcolor="#FFFFFF">Mobile：</td>
              ...
              <tr>
                <td height="25" align="right" bgcolor="#FFFFFF">Fax：</td>
              ...
              <tr>
                ...
                <td width="77%" height="0" valign="top" bgcolor="#FFFFFF"><input type="submit" value="Submit"
...
<script language="JavaScript">
function mailsend() {
						if($.trim($("#title").val())==''){alert('Please enter the subject');return false;}	
						if($.trim($("#content").val())==''){alert('Please enter the content');return false;}	
						if($.trim($("#companyname").val())==''){alert('Please enter a contact phone');return false;}	
						if($.trim($("#receiver").val())==''){alert('Please enter your name');return false;}
						if($.trim($("#phone").val())==''){alert('Please enter your contact phone number');return false;}	
