<?php
require "../../inc/en_download_core.php";
?>
                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>Download</strong></span></td>
	...
	<tbody>
		...
		<tr>
		  <td bgcolor="#ffffff" height="30">
				&nbsp;<?=$arrnews[$i][intro];?></td>
			<td height="30" align="right" bgcolor="#ffffff"><a href="/upload/news/<?=getnewspic($arrnews[$i][id_newsinfo]);?>" target="_blank">PDF</a></td>
		</tr>
		<tr>
