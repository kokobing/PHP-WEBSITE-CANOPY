...
bgcolor="#ffffff" border="0">
                  ...
                  background="/inc/pics/imgbeq/home_18.jpg" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        style="COLOR: #ffffff"><strong>成功案例</strong></span></td>
  ...
  <tr>
    <td align="left" ><table width="100%" border="0">
        <tr>
          <td width="226"  height="30">&nbsp;<a href='#'>案例</a>&nbsp;&gt;&gt;&nbsp;所有成功案例 </td>
          <td width="227">&nbsp;</td>
          <td width="102">共有 <?=sizeof($arrnews);?> 个成功案例</td>
        </tr>
    </table></td>
  </tr>
  <tr>
                  ...
                  border="0">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="/case/su_casepage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>"><img src="/upload/news/<?=getnewspic($arrnews[$i][id_newsinfo]);?>" width="150" height="100" border=0 /></a></td>
                      ...
                      background="/inc/pics/imgbeq/caseBottom02.gif" 
                        ...
                        height="22"><a href="/case/su_casepage.php?newsid=<?=$arrnews[$i][id_newsinfo];?>"><font color="#ffffff"><?=$arrnews[$i][title];?></font></a></td>
